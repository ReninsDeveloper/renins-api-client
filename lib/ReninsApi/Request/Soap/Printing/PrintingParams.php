 ...
 *   Тип 7 с печатью - означает фактическое подтверждение полиса (финальный этап)
 *
 *   В некоторых случаях тип 7 нельзя распечатать до импорта. Даже без печати.
 *   Например: Если не указан номер БСО (его можно указать только в импорте).
 *     Или если ТС старше 3 лет, то в импорте надо указать талон ТО
 *
