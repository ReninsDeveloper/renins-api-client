...
{
    protected $rules = [
        'Manufacturer' => ['toString', 'notEmpty'],
        'Model' => ['toString', 'notEmpty'],
        'Year' => ['toInteger', 'notEmpty'],
        'Cost' => ['toDouble', 'notEmpty', 'min:0'],
        ...
        'ManufacturerType' => ['toInteger', 'in:0|1'],
        'IsNew' => ['toLogical'],
        'IsTaxi' => ['toLogical'],
        'Power' => ['toInteger', 'notEmpty'],
        'GrossWeight' => ['toInteger', 'min:0'],
        'PassangerCapacity' => ['toInteger', 'min:0'],
        'Category' => ['toString', 'vehicleCategory'],
        'CarBodyType' => ['toString', 'vehicleBodyType'],
