...
class Validator
{
     ...
     * @return bool|string
     */
    public static function checkPurpose($value, $params = null)
    {
        return self::checkIn($value, 'личная|учебная езда|инкассация|скорая помощь|такси|дорожные и специальные ТС' .
            '|аренда/прокат|перегон|тест-драйв|коммерческая|доставка|прочее|перевозка опасных и легко воспламеняющихся грузов' .
            '|регулярные пассажирские перевозки/перевозки пассажиров по заказам|экстренные и коммунальные службы');
    }
